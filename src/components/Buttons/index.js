...
class AddBtn extends Component{
    render(){
        ...
        return(
            <AddRemoveBtnWrapper onClick={addHandler} type="submit"><Check/></AddRemoveBtnWrapper>
        )
    }
}
...
class RemoveBtn extends Component{
    render(){
        ...
        return(
            <AddRemoveBtnWrapper onClick={removeHandler} type="submit"><X/></AddRemoveBtnWrapper>
        )
    }
}
